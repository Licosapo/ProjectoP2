...
public enum GestorSemanaAulas {
    ...
    private void popularDados() {
        ...
        professorManuelSilva.adicionarHorario(new Horario(DiaSemana.SEGUNDA_FEIRA, 17, 2));
        professorCarlosSantos.adicionarHorario(new Horario(DiaSemana.TERCA_FEIRA, 17, 2));
        professorJoseMonteiro.adicionarHorario(new Horario(DiaSemana.QUARTA_FEIRA, 17, 2));
        ...
        segurancaMiguelMarques.adicionarHorario(new Horario(DiaSemana.SEGUNDA_FEIRA, 8, 8));
        segurancaMiguelMarques.adicionarHorario(new Horario(DiaSemana.TERCA_FEIRA, 8, 8));
        segurancaMiguelMarques.adicionarHorario(new Horario(DiaSemana.QUARTA_FEIRA, 8, 8));
        segurancaMiguelMarques.adicionarHorario(new Horario(DiaSemana.QUINTA_FEIRA, 8, 8));
        segurancaMiguelMarques.adicionarHorario(new Horario(DiaSemana.SEXTA_FEIRA, 8, 8));

        segurancaJoaoSantos.adicionarHorario(new Horario(DiaSemana.SEGUNDA_FEIRA, 16, 8));
        segurancaJoaoSantos.adicionarHorario(new Horario(DiaSemana.TERCA_FEIRA, 16, 8));
        segurancaJoaoSantos.adicionarHorario(new Horario(DiaSemana.QUARTA_FEIRA, 16, 8));
        segurancaJoaoSantos.adicionarHorario(new Horario(DiaSemana.QUINTA_FEIRA, 16, 8));
        segurancaJoaoSantos.adicionarHorario(new Horario(DiaSemana.SEXTA_FEIRA, 16, 8));

        segurancaAntonioSilva.adicionarHorario(new Horario(DiaSemana.SABADO, 8, 8));
        ...
        aula1.atribuirProfessor(professorManuelSilva);
        aula2.atribuirProfessor(professorCarlosSantos);
        aula3.atribuirProfessor(professorJoseMonteiro);
        ...
        aula3.adicionarAluno(aluno1);
        aula3.adicionarAluno(aluno2);
        aula3.adicionarAluno(aluno3);
    }
}
